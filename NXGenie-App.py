...
st.markdown("<h3 style='text-align: center;'>Welcome to NXGenie!</h3>", unsafe_allow_html=True)
st.markdown("<h3 style='text-align: center;'>An AI assistant that cleans, optimizes, and documents your NXOpen journals/code, saving your time and improving code quality</h3>", unsafe_allow_html=True)
